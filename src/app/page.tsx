  ...
  return (
    <main className="min-h-screen p-6 md:p-10 max-w-5xl mx-auto">
      <header className="mb-12 flex flex-col items-center">
        <h1 className="text-4xl font-bold text-center mb-4 text-slate-900">Программа серфкемпа</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 md:p-8 mb-12 border border-slate-100">
        ...
        <div className="text-sm text-slate-500">
          ...
          <br />
          Программа организована по дням недели и повторяется каждые 2 недели.
        </div>
        ...
        {startDate && endDate && !errorMessage && (
          <div className="mt-4 p-3 bg-blue-50 text-blue-700 border border-blue-100 rounded-lg text-sm">
            Выбран период: с {formatDate(startDate)} по {formatDate(endDate)}
          </div>
        )}
      </div>
                  ...
                  <div className="bg-slate-50 p-6 rounded-lg border border-slate-100">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="md:w-3/4">
                        <p className="text-slate-700 mb-4">{item.curriculum.description}</p>
                        
                        <div className="space-y-3">
                          <div className="flex items-start">
                            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 text-blue-600 mr-3 shrink-0">
                            ...
                            <div>
                              <span className="font-medium text-slate-700 block">Утро</span>
                              <span className="text-slate-600">{item.curriculum.schedule.morning}</span>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              <span className="font-medium text-slate-700 block">День</span>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              <span className="font-medium text-slate-700 block">Вечер</span>
